        ...
        <div>
          ...
          {(()=>{
            if (this.props.driverStatus.closed){
              return(
                <div>
                  ...
                  <div className={styles.top__toggle__work}
              ...
              return(
                <div>
                  <div className={styles.top__logo__container}></div>
                  <div className={styles.top__toggle__work} 
            ...
            {(()=>{
              if(this.props.driverStatus.opened){
                ...
                <div className={styles.driver__order__list}>
                  <div className={styles.driver__order__item}>
                  <OrderCard
                  startTitle='锦江瑞康医院'
                  startInfo='成都市成华区牛市口'
                  endTitle='天府软件园A区'
            ...
            {(()=>{
              if(this.props.driverStatus.closed){
                return (
                <div className={styles.driver__status__closed}></div>
                )
              }
            })()}    
            {/* fill empty */}
            {(()=>{
              if(this.props.driverStatus.fillEmpty){
                return (
                  ...
                  <div className={styles.driver__status__button}
            ...
            {(()=>{
              if(this.props.driverStatus.evaluationIp){
                ...
                <div className={styles.driver__status__evaluation__ip}>
                  <div className={styles.driver__status__button} style={{backgroundColor:'#bbbbbb'}}>
                      <div className={styles.driver__status__button__text}>
                      资料验证中
                      </div>
                    </div>
