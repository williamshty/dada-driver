  ...
  render() {
    return (
      ...
      <div>
        ...
        >
          <div className={styles.start__caption}>起点</div>
          <div className={styles.start__title}>
            {(() => {
              if (this.state.startTitle.length > 12) {
                return (
                  <span>
                    {this.state.startTitle.substr(0, 12)}
                    ...
                  </span>
                );
          ...
          <div className={styles.start__info}>
            {(() => {
              if (this.state.startInfo.length > 13) {
                return (
                  <span>
                    {this.state.startInfo.substr(0, 13)}
                    ...
                  </span>
                );
          ...
          <div className={styles.end__caption}>终点</div>
          <div className={styles.end__title}>
            {(() => {
              if (this.state.endTitle.length > 12) {
                return (
                  <span>
                    {this.state.endTitle.substr(0, 12)}
                    ...
                  </span>
                );
          ...
          <div className={styles.end__info}>
            {(() => {
              if (this.state.endInfo.length > 13) {
                return (
                  <span>
                    {this.state.endInfo.substr(0, 13)}
                    ...
                  </span>
                );
          ...
          <div className={styles.time__stamp}>{this.state.time}</div>
          <div className={styles.trip__price}>{this.state.price} NAS</div>
